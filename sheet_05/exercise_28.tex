...
If~$I$ and~$J$ are two ideals in~$A$ with~$I \subseteq J$ then also~$\gr[i](I) \subseteq \gr[i](J)$ for all~$i$ and thus~$\gr(I) \subsetneq \gr(J)$.
...
\begin{remark}
  ...
  \footnote{In \cite[Proposition~6.7]{noncommutative_noetherian} the above \lcnamecref{pulled back generating set} is implicitely used, and for a missing calculations the authors refer to an earlier proof --- namely that of Hilbert’s basis theorem.}%
